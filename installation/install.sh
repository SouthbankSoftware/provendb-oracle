...
if [[ "$PLATFORM" = "Darwin" ]]; then
    DOWNLOAD_LINK="https://storage.googleapis.com/provendb-prd/provendb-oracle/provendb-oracle-mac.tar.gz"
elif [[ "$PLATFORM" = "Linux" ]]; then
    DOWNLOAD_LINK="https://storage.googleapis.com/provendb-prd/provendb-oracle/provendb-oracle-linux.tar.gz"
    OPTS="--overwrite"
else
    echo "unsupported platform \`$PLATFORM\`, please try to build from source: https://github.com/SouthbankSoftware/provendb-oracle"
    exit 1
fi
